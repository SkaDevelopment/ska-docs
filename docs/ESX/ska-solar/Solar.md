=== "🔎 Preview"
    ...
    [🛒 BUY](https://ska-webstore.tebex.io/category/esx){ .md-button .md-button--primary }
...
=== "📜LICENSE"
    ...
    8. UPDATES & SUPPORT
        ...
        Updates, patches, and bug fixes may be provided at the discretion of SKA Support is provided only to verified purchasers 
